...
```
cd existing_repo
git remote add origin https://gitlab.com/ecarl65/cython-dsp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ecarl65/cython-dsp/-/settings/integrations)
